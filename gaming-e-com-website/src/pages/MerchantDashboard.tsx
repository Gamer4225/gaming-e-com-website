  ...
  return (
    <div className="admin-body">
      ...
      <div className="stats-row">
        <div className="stat-card"><div className="icon-circle purple">📦</div><div className="stat-info"><div className="value">{d.totalProducts}</div><div className="label">Products Listed</div></div></div>
      ...
      <div className="card" style={{ marginTop: 20 }}>
        ...
        <div className="tbl-wrap"><table className="tbl">
          <thead><tr><th>Category</th><th>Products</th><th>OOS</th></tr></thead>
      ...
      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 8 }}>
        ...
        <button className="btn btn-secondary" onClick={() => setCurrentPage("admin-ordered")}>Most Ordered</button>
      </div>
    </div>
  );
}
